...
puede concluir:\newline 
- Con el sistema de anotaciones de Jif es posible
proveer una herramienta para que el desarrollador Android evalúe el cumplimiento de políticas de
...
detección de fugas de información generadas mediante flujos implícitos.\\
...
Adicional a lo anterior, extender el setup de Jif para Android como se
propone en el diseño de solución ideal, implica una serie de retos importantes,
entre ellos:\newline 
...
lenguaje Java estandar. Por ejemplo, es necesario dar soporte a las clases
java.lang.Override, tal como se describe en \ref{sub:override}.\\
- Código de la API de Android que no pueda definitivamente no pueda ser
soportado. Para aspectos del código que definitivamente no puedan ser soportadas
