...
- Se podría definir un Principal por cada tipo de source, así por ejemplo, los
sources que permiten obtener la ubicación del 

 Incluir otros Principales, con el fin de anotar políticas de seguridad
con niveles de seguridad más granulares, puesto que, al tener diferentes Principales
es posible delegar un listado de Principales con autorización para leer o
escribir la información de las aplicaciones, ampliando los niveles de seguridad
alto y bajo, con que se anota la información hasta el momento.
