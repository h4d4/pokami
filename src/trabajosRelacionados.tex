...
relación de confianza entre principales, se define la relación acts-for, a partir
de la cual, se derivan dos tipos de principales: top principal y botton
principal, un top principal puede actuar para todos los principales, mientras
que, un botton principal permite que todos los principales actúen para el. Las
políticas de seguridad se condensan en Políticas de Confidencialidad y Políticas
de Integridad, con ellas se determina el conjunto de principales readers y
