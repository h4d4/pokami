...
Dos términos son fundamentales para hablar de llamada a métodos en Jif:
argumentos formales y argumentos actuales. Los argumentos actuales hacen
referencia a los labels de seguridad con que se definen los parámetros de un
método. Los labels actuales hacen refe
