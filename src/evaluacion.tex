...
- Desempeño:\newline 
la técnica de lenguajes tipados de seguridad en que se basa el
...
del análisis sean menos precisos, generando más falsos positivos(FP). En
consecuencia, se tiene un análisis unsound.\newline
...
JoDroid se fundamenta en análisis de control de flujo de información, aplicando
...
código fuente del aplicativo a analizar. No se requiere la específicación de
sources y sinks**.\\
% Para aspectos de evaluación del
% prototipo no se requiere la especificación de sources y sinks, puesto que
% estos ya están definidos en el anotador, de acuerdo a la política que se está
% evaluando.\\
