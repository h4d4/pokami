...
diseño ideal para contribuir con la solución del problema es: una herramienta que contenga el setup de Jif
para Android, e integregre un clasificador de sources y sinks, de tal manera que
la herramienta permita evaluar el control de flujo de información en aplicativos
Android. Así, mediante anotaciones Jif en el código de su aplicación, el
desarrollador define la política de seguridad a evaluar.
...
soportar un conjunto reducido de clases de la Api de Android, y en integrar un
...
prototipo de anotacion automático que anota el conjunto de aplicativos a
analizar acorde a la política de seguridad que se evalua. 
