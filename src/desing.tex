...
\section{\textcolor{red}{Diseño de la solución}}
...
La solución a diseñar consiste en un anotador que genere las anotaciones
respectivas del aplicativo, acorde a una política de seguridad previamente
definida.
...
los pasos necesarios para el diseño del anotador \ref{subsec:pasosSol}.
...
\subsection{Pasos para del anotador}
...
definida. Luego el programa obtenido se evalua con el compilador de Jif.\newline
Ahora, para que el compilador de Jif reconozca classes específicos de la Api de
Android, es necesario Anotarlas. De este modo, son dos los pasos para el diseño
de la solución.\newline
Paso uno: anotación de clases de la API de Android; y, Paso dos: criterios para
implementar el anotador. A continuación, se describen los pasos detalladamente.
}
