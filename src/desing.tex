...
La figura XXX expone el funcionamiento del anotador\newline
...
el código fuente .jif de las aplicaciones a analizar.\newline
Esta estructura de directorios se compone de la siguiente manera 
