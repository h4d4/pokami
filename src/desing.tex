...
Método source: un método source es un método(definido dentro de la clase) que
cuando es invocado, contiene dentro de los parámetros de invocación, al menos
...
source, y verificar si los métodos de la clase influencían la información de
...
\textit{Definición A:}\newline
Anotación de variables source: como las variables source tienen nivel de
...
\textit{Definición B:}\newline
Anotación de métodos a sobreescribir: el BL de los métodos a sobreescribir(de la
API) deben ser anotados con label de seguridad bajo \{\}, puesto que en su respectiva
definición en las clases de la API, han sido definidas con ese BL.\newline
\textit{Definición C:}\newline
Anotación de métodos source: 
