...
\textbf{\textit{Estructuración del esquema de anotación para aplicativos a
analizar}}\newline 
...
Para hacer referencia a los elementos que se anotan mediante el esquema de
anotación, se establecen una serie de términos, así:\\
Variable source: una variable source es una variable que almacena información
proveída por algún elemento del conjunto de sources.\newline
Array source: un array source es un array que almacena información de variables
source.\newline
Método que se sobreescribe: hace referencia a métodos de la API android que
deben ser sobreescrtos para la implementación del aplicativo, por ejemplo, el
...
una varible source.\newline
Método no source: un método no source es un método(definido dentro de la clase)
que cuando es invocado, no contiene dentro de los parámetros de invocación,
varibles source.
...
se debe garantizar que sólo el principal dueño de la información podrá
...
\textit{Definición C:} anotación de método que se sobreescribe.\newline
...
source), la información a conocer mediante el método también debe tener nivel de
seguridad alto.\newline 
Al tratarse de información con nivel de seguridad alto, sólo sentencias del
programa que también tengan un nivel de seguridad alto podrán conocer la
información proporcionada por el método.\newline 
Buscando hacer cumplir lo anterior, se anota con label de seguridad \{Alice:\}
el RTL y el BL del método.
...
\textit{Pasos para identoficar los elementos y aplicar su respectiva anotación:}
