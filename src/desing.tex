...
En el presente capítulo se describe la propuesta de solución para el problema
previamente descrito. El capitulo está compuesto por tres secciones, así: en la
sección \ref{sec:propuesta-sol} se describe la propuesta de solución, en la
sección \ref{sec:sol-desig} se describe el diseño para la propuesta planteada,
y en las secciones: \ref{subsection:politica}, \ref{subsection:politica} y
\ref{sec:lineamientos}, se dan detalles necesarios para concretar el diseño de
solución propuesto.
